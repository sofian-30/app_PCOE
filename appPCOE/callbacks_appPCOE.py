...
def update_table_data(n_btn_submit_validate, selected_row_number, client, erp_number, 
    ...
    if n_btn_submit_validate:
        ...
        # if selected_row_data:
        #     # Mettez à jour la ligne modifiée dans les données actuelles du tableau
        #     for key, value in updated_data.items():
        #         selected_row_data[key] = value

        # # Mettez à jour les données dans le dcc.Store
        # updated_data_list = current_data
